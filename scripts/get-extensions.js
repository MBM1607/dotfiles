...
Sourced from [Wes Bos](https://github.com/wesbos/dotfiles)
...
async function getExtensions() {
  ...
  // This is janky AF don't judge me
...
function makeMarkdownTable(extensions) {
  ...
  const markdownTable = `Here are a list of all the extensions I use. This is an ever-changing setup, so it might be out of date. Check back for updates!
